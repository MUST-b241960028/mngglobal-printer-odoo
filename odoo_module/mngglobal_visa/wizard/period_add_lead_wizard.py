...
class MngVisaPeriodAddLeadWizard(models.TransientModel):
    ...
    _description = "Хуваарилаагүй аппликейшнийг элсэлтийн үед нэмэх визард"
    ...
    application_ids = fields.Many2many(
        ...
        string="Сонгох хуваарилаагүй аппликейшнууд",
    ...
    def action_add_leads(self):
        ...
        return {
            ...
            "params": {
                "title": _("Кохортод нэмлээ"),
                "message": _("Нийт %s аппликейшнийг '%s' элсэлтийн үед нэмлээ.") % (
